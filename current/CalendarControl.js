      ...
      for(var dayOfWeek=0; dayOfWeek < 7; dayOfWeek++) {
        ...
        if(validDay) {
          if (dayOfMonth == selectedDay && currentYear == selectedYear && currentMonth == selectedMonth) {
            css_class = 'current';
          } else if (flightDays.indexOf(''+dayOfWeek)!=-1) {
            css_class = 'flightday'; 
...
//    table = table + "<tr class='header'><th colspan='7' style='padding: 3px;'><a href='javascript:clearCalendarControl();'>Clear</a> | <a href='javascript:hideCalendarControl();'>Close</a></td></tr>";
  ...
  this.show = show;
  function show(field,hidefield,daysForShow) {
    can_hide = 0;
    flightDays=daysForShow;       
  ...
  function hide() {
    if(dateField) {
      ...
      dateField = null;
      if(HideFocusField) {
        document.getElementById(HideFocusField).focus();
        HideFocusField=null;
      }
    }
  }
...
function showCalendarControl(textField,daysForShow,FocusOnHideID) {
  // textField.onblur = hideCalendarControl;
  calendarControl.show(textField,FocusOnHideID,daysForShow);
}
